...
::Fixed a multitude of issues related to finding and using the KWAD builder.
::Added an option to skip the version increment in modinfo.txt
::Added options to skip building scripts.zip
::Added Hypersizzler mode, which automatically makes a quick build without further prompts.
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@echo off
setlocal
setlocal EnableDelayedExpansion
::Bd is an all-purpose build variable, M is the mod path that's remembered during kwad setup, H is a Hypersizzler flag
set %%_Bd=0
set _M=0
set _H=0
...
echo Type H to enable Hypersizzler mode: new build, update scripts, don't update kwads, launch the game, suppress prompts.
echo Type A to abort the building process.
choice /c:BFVRSHA /n /m "Select [B], [F], [V], [R], [S], [H] or [A]."
...
IF %ERRORLEVEL% EQU 6 echo HYPERSIZZLER ENABLED && set /a _H=1 && goto executeBuild
...
echo MODINFO OK
::If we're in Hypersizzler mode, we skip the prompt
